...
<body>
    ...
    <script>
        $(document).ready(function() {
            $("#formAskGpt").submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        document.getElementById('chatgpt-box').appendChild(target);
                        typeWriterHtmlWithScript(response.responseText, target, 10);
                    },
            ...
            // function typeWriterHtml(html, container, speed = 10) {
            ...
            //             const clone = node.cloneNode(false); // tag kosong
            ...
            //                     typeNode(children[index], clone, function() {
            //                         index++;
            //                         typeNextChild();
            //                     });
            //                 } else {
            ...
            //     function typeNext() {
            //         if (index < children.length) {
            //             typeNode(children[index], container, function() {
            //                 index++;
            //                 typeNext();
            //             });
            //         } else {
            ...
            function typeWriterHtmlWithScript(html, container, speed = 10) {
                const temp = document.createElement("div");
                temp.innerHTML = html;
                ...
                function typeNext() {
                    if (index < children.length) {
                        ...
                        // setelah selesai semua, jalankan script tag
